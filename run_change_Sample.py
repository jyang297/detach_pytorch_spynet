...
class Network(torch.nn.Module):
    def __init__(self):
        ...
        self.netBasic = torch.nn.ModuleList([ Basic(intLevel) for intLevel in range(3) ])
    ...
    def forward(self, tenOne, tenTwo):
        ...
        for intLevel in range(5):
            ...
            # end
            if tenOne[0].shape[2] > 32 or tenOne[0].shape[3] > 32:
                down_image_1 = F.interpolate(tenOne[0], scale_factor=0.5, mode="bilinear", align_corners=False,
